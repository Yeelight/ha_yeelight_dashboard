...
const REBUILD_WIDGETS = new Map([
  ...
  ["quick-scenes", ["custom:yeelight-dashboard-scene-strip-card", "quick"]],
  ["scene-list", ["custom:yeelight-dashboard-scene-strip-card", "list"]],
  ["quick-command-card", ["custom:yeelight-dashboard-routine-card", "commands"]],
  ["script-panel", ["custom:yeelight-dashboard-routine-card", "scripts"]],
  ["schedule", ["custom:yeelight-dashboard-routine-card", "schedule"]],
  ["automations", ["custom:yeelight-dashboard-routine-card", "automations"]],
  ["scene-single-card", ["custom:yeelight-dashboard-routine-card", "scene-single"]],
  ["automation-single-card", ["custom:yeelight-dashboard-routine-card", "automation-single"]],
  ["script-single-card", ["custom:yeelight-dashboard-routine-card", "script-single"]],
  ["button-card", ["custom:yeelight-dashboard-routine-card", "button"]],
  ["devices", ["custom:yeelight-dashboard-device-card", "activity"]],
  ["device-list", ["custom:yeelight-dashboard-device-card", "list"]],
  ["device-single", ["custom:yeelight-dashboard-device-card", "single"]],
  ["universal-card", ["custom:yeelight-dashboard-device-card", "universal"]],
  ...
  ["ecosystem", ["custom:yeelight-dashboard-health-card", "ecosystem"]],
